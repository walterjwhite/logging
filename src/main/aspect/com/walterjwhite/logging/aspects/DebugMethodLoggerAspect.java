...
public class DebugMethodLoggerAspect {
  ...
  @Around(
      "execution(protected * *(..)) && !within(com.walterjwhite.logging..*) && !call(*.new(..)) && !@annotation(com.walterjwhite.logging.annotation.ContextualLoggable) && !@annotation(com.walterjwhite.logging.annotation.NonLoggable) && !within(*..*$AjcClosure*) && !execution(* *lambda$*(..))")
